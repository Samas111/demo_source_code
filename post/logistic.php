...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$inputDate || $inputDate < $today) {
        ...
        $error_msg = "Maximální kapacita je 100 osob.";
    } elseif ($price > 1000) {
...
<head>
    ...
    <link rel="stylesheet" href="openclass.css?version=2">
...
<form method="POST" id="logisticForm">
    ...
    <div class="title">
        ...
        <div class="flex">
            <input type="number" name="capacity" min="1" max="100" placeholder="Kapacita" value="<?= htmlspecialchars($val_capacity) ?>" required>
...
function updateLogic() {
    ...
    } else if (cVal > 100 || pVal > 1000) {
        document.getElementById('revenueHint').innerText = "Chyba: Kapacita max 100, Cena max 1000 Kč!";
