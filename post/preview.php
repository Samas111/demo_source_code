...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['publish_confirmed'])) {
    ...
    try {
        ...
        header("Location: /main-indexes/openclass-listing.php?id=" . $openclass_id . "&animation=1");
        exit;
    } catch (Exception $e) {
        $mysqli->rollback();
...
<head>
    ...
    <link rel="stylesheet" href="/main-indexes/main-css/openclass.css">
    <link rel="stylesheet" href="/post/register.css">
