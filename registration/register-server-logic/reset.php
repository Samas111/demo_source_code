...
if ($conn->connect_error) {
    header("Location: ../register-indexes/reset.php?message=error");
    exit;
}
...
$redirectBase = "../register-indexes/reset.php";
...
if ($result && $row = $result->fetch_assoc()) {
    ...
    $resetLink = "https://dancefy.cz/logic/reset-password.php?token=" . $token;
