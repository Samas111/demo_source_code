...
<div class="feed-root">
    <?php if (empty($followingFeed)): ?>
        <div class="update-info">
            <p><?= $T['start_following'] ?> <strong><?= $T['favorite_creators'] ?>!</strong></p>
        </div>
    <?php else: ?>
        <div class="update-info">
            <?php
            ...
            ?>
            <p><?= $T['new'] ?> <strong><?= $recentFollowingCount ?></strong> <?= $T['posts'] ?></p>
        </div>
    <?php endif; ?>
<div class="feed">
