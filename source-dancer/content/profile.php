            ...
            <div class="profile-right">
                ...
                <div class="profile-stats">
                    <div class="stat">
                        ...
                        <span class="stat-label"><?= $T['attended_classes'] ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="profile-warning" onclick="window.location='/settings/profile.php'">
            <div class="warning-left">
                ...
                <div class="warning-text">
                    <span class="warning-title"><?= $T['complete_profile'] ?></span>
                    <span class="warning-sub"><?= $T['profile_visible'] ?></span>
                </div>
            </div>
            <div class="warning-action"><?= $T['edit'] ?></div>
        </div>
    <?php endif; ?>
    <section class="openclass-section">
        <?php if (!empty($items)): ?>
            <h3 class="openclass-title"><?= $T['your_portfolio'] ?></h3>
        <?php endif; ?>
        <?php foreach ($items as $item): ?>
            <div class="openclass-card">
                ...
                <button class="openclass-cta" onclick="window.location='/main-indexes/openclass-listing.php?id=<?php echo $item['openclass_id']; ?>'"><?= $T['show'] ?></button>
                </div>
