...
// Use the global objects from your new bootstrap
$db = $GLOBALS['DB'];
$me = $GLOBALS['AUTH_USER']['public_id']; // No need to check session here, logic.php handles it
...
<div class="list-container">
    <div class="search-wrapper">
        <div class="search-input-container">
            <input type="text" id="contactSearch" placeholder="<?= $T['search_dancers'] ?>" onkeyup="filterContacts()">
        </div>
    </div>
    ...
    <div class="chats-list" id="chatsList">
        ...
        <?php foreach($chats as $c): 
            $displayName = !empty($c['display_name']) ? $c['display_name'] : $T['deleted_user'];
            ...
            $previewText = $hasMessage ? htmlspecialchars($c['last_msg']) : $T['tap_to_chat'];
