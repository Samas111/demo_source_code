...
<div class="feed-fixed">
    <div class="feed-switch">
        <span class="switch-btn switch-active" data-target="following"><?= $T['following'] ?></span>
        <span>|</span>
        <span class="switch-btn" data-target="discover"><?= $T['discover'] ?></span>
    </div>
</div>
<div class="feed-root">
    <a href="../post/post.php" class="post-href"><img src="/source/assets/add.png">Připravit OpenClass</a>
<div class="feed">
                    ...
                    <div class="content-part">
                        <div class="divider">
                            ...
                            <div class="report-popup">
                                <button class="report-action"> <?= $T['report'] ?></button>
                            </div>
                        </div>
                        ...
                        <div class="action-panel" style="display: none;">
                            <div class="user-actions" style="display: none;"
                                ...
                                <div class="count"> <?= $T['upvote'] ?></div>
                                <img src="source/assets/share.png">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="main-content event-content">
                            <div class="event-left">
                                ...
                                <button class="event-cta"
                                        onclick="window.location='../../openclass-listing.php?id=<?= $item['openclass_id'] ?>'">
                                     <?= $T['view'] ?>
                                </button>
                            </div>
